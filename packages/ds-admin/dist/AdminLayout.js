...
function AdminLayoutInner({ children, sidebar, header, collapsible = true, afterHeader, afterMain, className, }) {
    ...
    return (_jsxs("div", { className: rootClass, "data-surface": "product", children: [sidebar, header, afterHeader, _jsx("main", { className: "ds-admin__main", children: _jsx("div", { className: "ds-admin__content", children: _jsx("div", { className: "ds-admin__container", children: children }) }) }), afterMain] }));
}
