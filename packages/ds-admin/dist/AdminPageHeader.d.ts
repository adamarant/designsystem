 ...
 */
export declare function AdminPageHeader({ title, onBack, backLabel, actions, titleClassName, className, }: AdminPageHeaderProps): import("react/jsx-runtime").JSX.Element;
