...
const Description = forwardRef<HTMLParagraphElement, HeroDescriptionProps>(function D({ className, ...r }, ref) { return <p ref={ref} className={cn("ds-hero__subtitle", className)} {...r} />; });
const Actions = forwardRef<HTMLDivElement, HeroActionsProps>(function A({ className, ...r }, ref) { return <div ref={ref} className={className} {...r} />; });
