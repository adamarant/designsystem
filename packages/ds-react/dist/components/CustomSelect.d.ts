import { type SelectOption, type SelectSize } from "./Select";
/**
...
export declare function CustomSelect({ options, value, onChange, placeholder, searchable, searchPlaceholder, disabled, size, className, label, }: CustomSelectProps): import("react/jsx-runtime").JSX.Element;
