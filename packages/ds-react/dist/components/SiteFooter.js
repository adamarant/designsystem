...
/* ---------- compound parts ---------- */
export const SiteFooterBody = forwardRef(function SiteFooterBody({ className, ...rest }, ref) {
...
export const SiteFooterSocial = forwardRef(function SiteFooterSocial({ className, ...rest }, ref) {
    return (_jsx("div", { ref: ref, className: cn("ds-footer__social", className), ...rest }));
});
export const SiteFooterCredits = forwardRef(function SiteFooterCredits({ className, ...rest }, ref) {
    return (_jsx("div", { ref: ref, className: cn("ds-footer__credits", className), ...rest }));
});
/* ---------- root ---------- */
const SiteFooterRoot = forwardRef(function SiteFooter({ brand, tagline, social, columns, newsletter, copyright, legal, LinkComponent = "a", className, children, ...rest }, ref) {
