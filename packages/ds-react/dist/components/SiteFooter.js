...
/* ---------- root ---------- */
const SiteFooterRoot = forwardRef(function SiteFooter({ brand, tagline, social, columns, newsletter, copyright, legal, note, LinkComponent = "a", className, ...rest }, ref) {
