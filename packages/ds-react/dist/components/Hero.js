...
const Description = forwardRef(function D({ className, ...r }, ref) { return _jsx("p", { ref: ref, className: cn("ds-hero__description", className), ...r }); });
const Actions = forwardRef(function A({ className, ...r }, ref) { return _jsx("div", { ref: ref, className: cn("ds-hero__actions", className), ...r }); });
