 ...
 *   </ClipReveal>
 */
export const ClipReveal = forwardRef(function ClipReveal({ once = true, rootMargin = "0px 0px -8% 0px", className, children, ...rest }, ref) {
    ...
    return (_jsx("div", { ref: (node) => {
            ...
            if (typeof ref === "function")
                ...
                ref.current = node;
        }, className: cn("ds-clip-reveal", className), "data-clip-shown": shown ? "" : undefined, ...rest, children: children }));
});
