...
/*  Sub-components                                                     */
/* ================================================================== */
const TooltipContent = forwardRef(function TooltipContent({ className, style, ...rest }, ref) {
    return (_jsx("div", { ref: ref, role: "tooltip", className: cn("ds-tooltip__content", className), style: style, ...rest }));
});
/* ================================================================== */
...
const TooltipRoot = forwardRef(function Tooltip({ placement = "top", delay, className, children, ...rest }, ref) {
    ...
    const enhancedChildren = Children.map(children, (child) => {
        ...
        if (child.type === TooltipContent) {
            return cloneElement(child, {
                id: tooltipId,
                style: focused
                    ? { ...visibleStyle, ...child.props.style }
                    : child.props.style,
            });
        }
        return child;
