...
export const HeroBlock = defineBlock({
    ...
    render: ({ data }) => (_jsx("section", { className: "ds-section ds-flex ds-items-center", children: _jsxs("div", { className: "ds-container ds-flex ds-flex-col ds-items-center ds-text-center ds-gap-6 ds-max-w-3xl ds-mx-auto", children: [data.overline ? _jsx("p", { className: "ds-overline", children: data.overline }) : null, _jsx("h1", { className: "ds-heading-1", children: data.title }), data.lede ? _jsx("p", { className: "ds-copy", children: data.lede }) : null, data.cta?.href ? (_jsx("a", { href: data.cta.href, className: "ds-btn ds-btn--pill ds-btn--xl", ...(data.cta.external ? { target: '_blank', rel: 'noopener noreferrer' } : {}), children: data.cta.label || 'Scopri' })) : null] }) })),
});
