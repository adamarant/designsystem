...
export function SocialIcon({ network, size = 18 }) {
    const path = PATHS[network];
    if (!path)
        return null;
    return (_jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": "true", focusable: "false", children: _jsx("path", { d: path }) }));
}
