...
export const ProseBlock = defineBlock({
    ...
    render: ({ data }) => {
        ...
        return (_jsx("section", { className: "ds-section", children: _jsxs("div", { className: "ds-container ds-max-w-3xl ds-mx-auto", children: [hasHeading ? (_jsxs("div", { className: "ds-flex ds-flex-col ds-gap-4 ds-mb-8", children: [data.overline ? _jsx("p", { className: "ds-overline", children: data.overline }) : null, data.title ? _jsx("h2", { className: "ds-heading-2", children: data.title }) : null] })) : null, _jsx("div", { className: "ds-prose", children: paragraphs.map((p, i) => (_jsx("p", { children: p }, i))) })] }) }));
    },
});
