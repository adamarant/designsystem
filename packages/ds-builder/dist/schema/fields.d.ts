...
export type Field = TextField | RichTextField | NumberField | BooleanField | SelectField | ImageField | LinkField | ColorTokenField | ListField;
export type Fields = Record<string, Field>;
/** Map a single descriptor to its runtime value type. */
export type InferField<F extends Field> = F extends TextField ? string : F extends RichTextField ? string : F extends NumberField ? number : F extends BooleanField ? boolean : F extends SelectField<infer V> ? V : F extends ImageField ? ImageValue | null : F extends LinkField ? LinkValue | null : F extends ColorTokenField ? string : F extends ListField<infer I> ? Array<InferField<I>> : never;
