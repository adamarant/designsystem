...
import { validateFields, type ValidationIssue } from './validateFields.js'
 ...
 */
export function validateDocument(registry: Registry, doc: PageDocument): DocumentValidation {
